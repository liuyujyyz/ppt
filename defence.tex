...
Alice is finding a job. Alice makes a simple survey about all companies she is interested. She estimates the salary distributions according to the conditions of herself.\\
...
Input:
\begin{itemize}
\item a set of random variables $\{X_i\}$;
\item a collection of feasible set $\calF \subset 2^{[n]}$;
\end{itemize}
Output:
\begin{itemize}
